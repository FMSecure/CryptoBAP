...
Type sbir_tree = “:(sbir_event, int, (bir_var_t, bir_exp_t) symb_interpret_t) stree”
...
Define`single_step_execute_symbolic_tree (tre:sbir_tree) ev (tre':sbir_tree) =
(case ev of
...
Define `execute_symbolic_tree (tre:sbir_tree) Eve (tre':sbir_tree) =
(case Eve of
   [] => (tre = tre')
...
Define `symbolic_tree_transition_with_symb (Sym,P,tre:sbir_tree) Eve (Sym',P',tre':sbir_tree) =
(case Eve of
...
[~nil:]
  (symbolic_tree_multi_transitions_with_symb ((Sym:(Var_t -> bool)),(P:('SPpred -> bool)),(tr:sbir_tree)) [] ((Sym:(Var_t -> bool)),(P:('SPpred -> bool)),(tr:sbir_tree)))
[~moveF:]
  (((symbolic_tree_multi_transitions_with_symb ((Sym:(Var_t -> bool)),(P:('SPpred -> bool)),(tr:sbir_tree)) ev ((Sym'':(Var_t -> bool)),(P'':('SPpred -> bool)),(tr'':sbir_tree)))∧(symbolic_tree_transition_with_symb ((Sym'':(Var_t -> bool)),(P'':('SPpred -> bool)),(tr'':sbir_tree)) e ((Sym':(Var_t -> bool)),(P':('SPpred -> bool)),(tr':sbir_tree)))) ==> (symbolic_tree_multi_transitions_with_symb ((Sym:(Var_t -> bool)),(P:('SPpred -> bool)),(tr:sbir_tree)) (e::ev) ((Sym':(Var_t -> bool)),(P':('SPpred -> bool)),(tr':sbir_tree))))
[~moveB:]
  (((symbolic_tree_multi_transitions_with_symb ((Sym:(Var_t -> bool)),(P:('SPpred -> bool)),(tr:sbir_tree)) (e::ev) ((Sym':(Var_t -> bool)),(P':('SPpred -> bool)),(tr':sbir_tree)))∧(symbolic_tree_transition_with_symb ((Sym'':(Var_t -> bool)),(P'':('SPpred -> bool)),(tr'':sbir_tree)) e ((Sym':(Var_t -> bool)),(P':('SPpred -> bool)),(tr':sbir_tree)))) ==>
(symbolic_tree_multi_transitions_with_symb ((Sym:(Var_t -> bool)),(P:('SPpred -> bool)),(tr:sbir_tree)) ev ((Sym'':(Var_t -> bool)),(P'':('SPpred -> bool)),(tr'':sbir_tree))))
End        
...
val traces_of_tree_with_symb_def  = Define`
                                          traces_of_tree_with_symb ((Sym:(Var_t -> bool)),(P:('SPpred -> bool)),(tr:sbir_tree)) ((Sym':(Var_t -> bool)),(P':('SPpred -> bool)),(tr':sbir_tree)) = {e| (symbolic_tree_multi_transitions_with_symb (Sym,P,tr) e (Sym',P',tr'))}`;
